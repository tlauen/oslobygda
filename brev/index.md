...
<p class="kjeks-merknad">Skjemaet brukar kjeks (leverandør MailerLite). <a href="{{ '/personvern/' | relative_url }}">Les meir om kjeks og personvern</a>.</p>
...
- **Førehandvising av epost** <a href="{{ '/skript/preview_nyhendebrev.html' | absolute_url }}">{{ '/skript/preview_nyhendebrev.html' | absolute_url }}</a>
